java cProject in Advanced Algorithms and Data Structures 
COMP4134 UNNC 
...
is an implementation of an existing algorithm from the literature. 
...
Execute: java -Dfile.encoding=UTF-8 -XX:+UseSerialGC -Xss64m -Xms1920m -Xmx1920m AADS  Output.txt 
